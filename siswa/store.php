...
$tinggi_badan = isset($_POST['tinggiBadan']) ? $_POST['tinggiBadan'] : '';
$berat_badan = isset($_POST['beratBadan']) ? $_POST['beratBadan'] : '';
$jarak_sekolah = isset($_POST['jarak_ke_sekolah']) ? $_POST['jarak_ke_sekolah'] : '';
$waktu_tempuh = isset($_POST['waktuTempuh']) ? $_POST['waktuTempuh'] : '';
