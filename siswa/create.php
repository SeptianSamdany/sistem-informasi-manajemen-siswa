              ...
              <div class="card mb-4">
                ...
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="number" class="form-control" id="jumlahSaudara" name="jumlahSaudara" required>
                  </div>
                  <div class="form-group">
            ...
            <div class="col-md-6">
              <div class="card mb-4">
                ...
                <div class="card-body">
                  ...
                  <div class="form-group">
                    <label for="jarakSekolah">Jarak ke Sekolah (km)</label>
                    <input type="number" class="form-control" id="jarakSekolah" name="jarakSekolah" required>
                  </div>
                  <div class="form-group">
                    <label for="waktuTempuh">Waktu Tempuh (menit)</label>
                    <input type="number" class="form-control" id="waktuTempuh" name="waktuTempuh" required>
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    <label for="halLain">Hal yang Perlu Diketahui</label>
                    <input type="text" class="form-control" id="halLain" name="halLain" required>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div class="row">
                <div class="col-md-6">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="ttlAyah" name="ttlAyah" placeholder="Tempat, Tanggal Lahir" required>
                  </div>
                  <div class="form-group">
                ...
                <div class="col-md-6">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="ttlIbu" name="ttlIbu" placeholder="Tempat, Tanggal Lahir" required>
                  </div>
                  <div class="form-group">
