            ...
            ?>
              ...
              <table cellpadding="8" class="w-100">
                ...
                <tr>
                  ...
                  <td><input class="form-control" type="text" name="tempat_tanggal_lahir" placeholder="Tempat, Tanggal Lahir" required value="<?= $row['tempat_tanggal_lahir'] ?>"></td>
                </tr>
                <tr>
                  <td>Agama</td>
                ...
                <tr>
                  ...
                  <td><input class="form-control" type="text" name="tempat_tanggal_lahir_ayah" placeholder="Tempat, Tanggal Lahir Ayah" required value="<?= $row['tempat_tanggal_lahir_ayah'] ?>"></td>
                </tr>
                <tr>
